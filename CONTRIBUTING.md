...
On the top right side of [the repository on GitHub](https://github.com/buluma/ansible-role-gitlab_ee), click `fork`. This copies everything to your GitHub namespace.
